...
open class SimpleTableViewAdapter<ItemType, CellType: UITableViewCell>: NSObject, UITableViewDataSource, UITableViewDelegate where CellType: SimpleConfigurableCell, CellType.ItemType == ItemType {
